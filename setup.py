...
if __name__ == "__main__":
    setup(
        ...
        zip_safe=False,
<<<<<<< HEAD
        install_requires=['FireWorks>=1.4.8', 'pymatgen>=2017.7.21',
                          'custodian>=1.1.0', 'pymatgen-db>=0.7.0',
                          'monty>=1.0.1', 'tqdm>=4.7.4', 'six',
=======
        install_requires=['FireWorks>=1.4.0', 'pymatgen>=2017.8.16',
